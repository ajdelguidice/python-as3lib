...
class _itkDefaultAboutWindow:
    ...
    def open(self, itkWindow, *e):
        ...
        if itkWindow is not None:
            self.toplevel.transient(itkWindow)
    ...
    def __init__(self, **kwargs):
        ...
        if self._menu:
            if self._defaultMenu:
                ...
                self.menubar['helpmenu'].add_command(label='About as3lib', font=('Terminal', 8), command=partial(itkDefaultAboutWindow.open, self))
